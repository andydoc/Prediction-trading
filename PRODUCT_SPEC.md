...
| ⬚ **C6: Create USER_GUIDE.md** | Product overview, prerequisites, setup from scratch, starting/stopping (rationalised scripts), monitoring (dashboard), mode switching, recovery after crash, go-live checklist, glossary. Written so a new operator can run the system without having built it. |
