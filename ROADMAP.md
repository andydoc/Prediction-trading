...
**Done**: Circuit breaker (C1), POL gas balance monitoring (C1.1), Telegram notifications (C3), proactive near-resolution exit (C4.2).

**Remaining**: Kill switch (C2), daily P&L report (C4), seamless position close transition (C4.1), OPS_RUNBOOK.md (C5), USER_GUIDE.md (C6), retire PROGRESS_ROADMAP.md (C7).
