...
wsl bash -c "kill -9 \$(ps aux | grep -E 'main\.py|trading_engine|dashboard_server|initial_market_scanner' | grep -v grep | awk '{print \$2}') 2>/dev/null; sleep 2; rm -f /home/andydoc/prediction-trader/*.pid"
echo.
echo === State snapshot ===
